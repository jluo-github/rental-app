            ...
            <div className='hidden md:ml-6 md:block'>
              <div className='flex space-x-2'>
                <Link
                  ...
                  } text-white hover:bg-violet-800 hover:text-white rounded-md px-3 py-2`}>
                  Home
                </Link>
                <Link
                  href='/properties'
          ...
          {!isLoggedIn && (
            <div className='hidden md:block md:ml-6'>
              <div className='flex items-center'>
                <button className='flex items-center text-white bg-violet-700 hover:bg-violet-800 hover:text-white rounded-md px-3 py-2'>
      ...
      {isMobileMenuOpen && (
        <div id='mobile-menu'>
          <div className='space-y-1 px-2 pb-3 pt-2'>
            ...
            {!isLoggedIn && (
              <button className='flex items-center text-white bg-violet-700 hover:bg-violet-800 hover:text-white rounded-md px-3 py-2 my-4'>
                <span>Login or Register</span>
              </button>
            )}
          </div>
