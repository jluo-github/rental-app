          ...
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            ...
            <Link className='flex flex-shrink-0 items-center' href='/'>
              <Image
                ...
                alt='PropertyPulse'
              />
              {/* <span className='hidden md:block text-white text-2xl font-bold ml-2'>Property</span> */}
            </Link>
                ...
                {providers &&
                  Object.values(providers).map((provider, index) => (
                    <button
                      ...
                      key={index}
                      className='flex items-center text-white bg-violet-900 hover:bg-purple-900 hover:text-white rounded-md px-3 py-2'>
