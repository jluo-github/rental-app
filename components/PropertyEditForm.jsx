  ...
  return (
    !loading && (
      <form onSubmit={handleSubmit}>
        ...
        <div className='mb-4 bg-violet-100 p-4'>
        ...
        <div>
          <button
            className='bg-violet-500 hover:bg-violet-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline'
            type='submit'>
            Update Property
          </button>
        </div>
