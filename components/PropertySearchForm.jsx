    ...
    <form
      ...
      <div className='w-full md:w-3/5 md:pr-2 mb-4 md:mb-0'>
        ...
        <input
          ...
          placeholder='Enter Keywords (City, State, Zip, etc)'
          className='w-full px-4 py-3 rounded-lg bg-white text-gray-800 focus:outline-none focus:ring focus:ring-violet-500'
        />
      </div>
